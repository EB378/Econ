        ...
        <div className={styles.testamonials}>
            <div className={styles.bg2}>
                <div className={styles.textpadding}>
                    <h3>Testimonial 1: John Thompson, CEO of Thompson Tech Solutions</h3>
            ...
            <div className={styles.bg1}>
                <div className={styles.textpadding}>
                    <br/>
                    <h3>Testimonial 2: Michael Carter, Founder of Carter & Co. Financial Advisors</h3>
            ...
            <div className={styles.bg2}>
                <div className={styles.textpadding}>
                    <h3>Testimonial 3: Sarah Mitchell, Director of Operations at GreenEarth Innovations</h3>
